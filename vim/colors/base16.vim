...
call <sid>hi("Error",         g:gui08, g:gui05, s:cterm08, s:cterm00, "reverse", "")
...
call <sid>hi("MatchParen",    "", g:gui03, "", s:cterm03,  "", "")
call <sid>hi("ModeMsg",       g:gui0B, "", s:cterm0B, "", "", "")
...
call <sid>hi("StatusLine",    g:gui04, g:gui02, s:cterm01, s:cterm04, "none", "")
call <sid>hi("StatusLineNC",  g:gui03, g:gui01, s:cterm04, s:cterm01, "none", "")
