...
if has("gui_running") ||
    ...
    let s:dgrn_hex="287328"        " dark green hexadecimal    (color 2)
    let s:lgrn_hex="53a653"        " light green hexadecimal   (color 10)
    let s:dylw_hex="91894e"        " dark yellow hexadecimal   (color 3)
    let s:lylw_hex="bfcc85"        " light yellow hexadecimal  (color 11)
    let s:dblu_hex="395573"        " dark blue hexadecimal     (color 4)
    let s:lblu_hex="4779b3"        " light blue hexadecimal    (color 12)
    let s:dmag_hex="8c468c"        " dark magentahexadecimal   (color 5)
    let s:lmag_hex="b362b3"        " light magenta hexadecimal (color 13)
    let s:dcyn_hex="2b7694"        " dark cyan hexadecimal     (color 6)
    let s:lcyn_hex="47959e"        " light cyan hexadecimal    (color 14)
    let s:dwht_hex="9c9c9c"        " dark white hexadecimal    (color 7)
...
call s:HI(         "Search", s:lylw, s:dred,     "" )
call s:HI(      "IncSearch", s:lylw, s:dred,     "" )
...
call s:HI(     "StatusLine", s:dred, s:dwht,     "" )
call s:HI(   "StatusLineNC", s:dblk, s:dwht,     "" )
...
call s:HI(     "CursorLine", s:lblk,     "", "none" )
call s:HI(   "CursorLineNr", s:lblk, s:dwht, "none" )
call s:HI(   "CursorColumn", s:lblk,     "",     "" )
...
call s:HI("diffAdd",      s:lred, s:dblk, "")
call s:HI("diffChange",   s:dwht, s:dblk, "")
call s:HI("diffDelete",   s:lred, s:dblk, "")
call s:HI("diffText",     s:lred, s:dblk, "")
call s:HI("diffAdded",    s:lred, s:dblk, "")
call s:HI("diffFile",     s:lred, s:dblk, "")
call s:HI("diffNewFile",  s:lred, s:dblk, "")
call s:HI("diffLine",     s:lred, s:dblk, "")
call s:HI("diffRemoved",  s:lred, s:dblk, "")
